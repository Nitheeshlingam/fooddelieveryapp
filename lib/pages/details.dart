      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Corrected image rendering with better handling
            widget.image.isEmpty
                ? Image.asset(
                    'images/default_image.png', // Placeholder image if URL is empty
                ...
                : Image.network(
                    ...
                    errorBuilder: (BuildContext context, Object error,
                      ...
                      return Center(child: Icon(Icons.error)); // Handle error with icon
                    },
                  ),
            SizedBox(
              height: 15.0,
