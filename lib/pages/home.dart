...
import 'package:fooddelieveryapp/pages/details.dart';
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 5),
                              Text(
                                ds["Detail"] ?? "No details available",
      ...
      children: [
        ...
        GestureDetector(
          onTap: () async{
            ...
            salad = false;
            burger = false;
            fooditemStream = await DatabaseMethods().getFoodItem("Pizza");            setState(() {});
          },
          child: Material(
            elevation: 5.0,
            borderRadius: BorderRadius.circular(10),
